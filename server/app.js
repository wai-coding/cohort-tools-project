...
// COHORT ROUTES
// Route to create a cohort
app.post("/api/cohorts", (req, res) => {
  CohortModel.create(req.body).then((data) => {
    console.log("cohort added", data);
    res.status(500).json({ errorMessage: err });
  });
});

// Route to find all the cohorts
...
// Route to get one specific cohort by id
app.get("/appi/cohorts/:cohortId", async (req, res) => {
  try {
...
// Route to update one specific cohort by id
...
// Route to delete one specific cohort by id
